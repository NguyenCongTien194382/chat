  ...
  try {
    ...
    if (req.body && req.body.userId && Number(req.body.userId) && Number(req.body.latitude) && Number(req.body.longtitude)) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/updatelocation",
...
export const TakeListFriend = async (req, res, next) => {
  try {
    ...
    let listAccount = await User.find({ _id: { $in: arrayUserId } }, { userName: 1, avatarUser: 1, lastActive: 1, isOnline: 1, companyId: 1 }).sort({ isOnline: 1, lastActive: -1 }).limit(100).lean();
    //  "${urlImgHost()}avatarUser/12457/"
    if (result1) {
      if (listAccount) {
        let result = [];
...
export const TakeListFriend365 = async (req, res, next) => {
  try {
    ...
    if (req.params && req.params.userId && (!isNaN(req.params.userId))) {
      ...
      let condition = { id365: userId, type365: type365 };
      ...
      let dataUser = await User.find(condition, { _id: 1, companyId: 1 }).limit(1).lean();
      if (dataUser) {
        if (dataUser.length) {
          let result1 = await Contact.find({
            $or: [
          ...
          // list friend 
          let listAccount = await User.find({ _id: { $in: arrayUserId } }, { type365: 1, userName: 1, avatarUser: 1, lastActive: 1, isOnline: 1, companyId: 1, id365: 1, secretCode: 1 }).sort({ isOnline: 1, lastActive: -1 }).limit(300).lean();

          // list user not friend but in company 
          let listAccount2 = [];
          if (dataUser[0].companyId != 0) {
            listAccount2 = await User.find({ _id: { $nin: arrayUserId }, companyId: dataUser[0].companyId }, { type365: 1, userName: 1, avatarUser: 1, lastActive: 1, isOnline: 1, companyId: 1, id365: 1 }).sort({ isOnline: 1, lastActive: -1 }).limit(300).lean();
          }
          ...
          if (result1 && listAccount) {
            ...
            for (let i = 0; i < listAccount.length; i++) {
              ...
              if (listAccount[i].avatarUser.trim() != "") {
                ...
                a.avatarUser = `${urlImgHost()}avatar/${listAccount[i].userName[0]}_${getRandomInt(1, 4)}.png`
              }
              a.lastActive = listAccount[i].lastActive;
              a.isOnline = listAccount[i].isOnline;
              a.companyId = listAccount[i].companyId;
...
export const takeListNewFriend = async (req, res, next) => {
  try {
    ...
    let listAccount = await User.find({ _id: { $in: arrayUserId } }, { userName: 1, avatarUser: 1, lastActive: 1, isOnline: 1, companyId: 1 }).limit(100).lean();
...
export const SendLocation = async (req, res, next) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/SendLocation",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
          ...
          for (let i = 0; i < conversationGroupStart.length; i++) {
            ...
            if (keyword1 && keyword2) {
              ...
              if (ele && (Number(ele.memberId) == userId) && (removeVietnameseTones(ele.conversationName).toLowerCase().includes(removeVietnameseTones(keyword1).toLowerCase())) &&
                (removeVietnameseTones(ele.conversationName).toLowerCase().includes(removeVietnameseTones(keyword2).toLowerCase())) && (conversationGroup.length < 6 || (removeVietnameseTones(ele.conversationName).toLowerCase() === removeVietnameseTones(findword).toLowerCase() && findword !== ''))) {
                a.conversationId = conversationGroupStart[i]._id;
                a.companyId = 0;
                a.conversationName = ele.conversationName;
                ...
                a.listMessage = null;
                a.countMem = conversationGroupStart[i].count;
                if (removeVietnameseTones(ele.conversationName).toLowerCase() === removeVietnameseTones(findword).toLowerCase()) {
                  conversationGroup = [a, ...conversationGroup]
                }
                else {
                  conversationGroup.push(a)
                }
              ...
              let ele = conversationGroupStart[i].memberList.find(e => Number(e.memberId) == userId);
              if (ele && (Number(ele.memberId) == userId) && (removeVietnameseTones(ele.conversationName).toLowerCase().includes(removeVietnameseTones(findword).toLowerCase())) && (conversationGroup.length < 6 || (removeVietnameseTones(ele.conversationName).toLowerCase() === removeVietnameseTones(findword).toLowerCase() && findword !== ''))) {
                a.conversationId = conversationGroupStart[i]._id;
                a.companyId = 0;
                a.conversationName = ele.conversationName;
...
export const setupBase = async (req, res, next) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/setupBase",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
  ...
  try {
    ...
    if (req.body && req.body.NameClass && req.body.IdOwner && req.body.Color && Number(req.body.IdOwner)
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/CreateClassUser",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
  ...
  try {
    ...
    if (req.body && req.body.SenderID && (!isNaN(req.body.SenderID)) && req.body.IdClass) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/SendManyMesByClassId",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
  ...
  try {
    ...
    if (req.body && req.body.SenderID && (!isNaN(req.body.SenderID)) && req.body.ListUserId && req.body.Message) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/SendMesListUserId",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
  ...
  try {
    ...
    if (req.body && req.body.userId && req.body.ArrayClassId) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/AddUserToManyClass",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
  ...
  try {
    ...
    if (req.body && req.body.IdClass && String(req.body.IdClass) && req.body.ArrayUserId && (String(req.body.ArrayUserId).includes("["))) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/InsertUserToClassUser",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
  ...
  try {
    ...
    if (req.body && req.body.IdClass && String(req.body.IdClass) && req.body.ArrayUserId && (String(req.body.ArrayUserId).includes("["))) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/DeleteUserFromClassUser",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
  ...
  try {
    ...
    if (req.body && req.body.IdClass && req.body.content) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/EditClassUserName",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
  ...
  try {
    ...
    if (req.body && req.body.IdClass && req.body.Color) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/EditClassUserColor",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
  ...
  try {
    ...
    if (req.body && req.body.IdClass) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/EditClass",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
  ...
  try {
    ...
    if (req.body && req.body.IdClass) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/DeleteClassUser",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
  ...
  try {
    ...
    if (req.body && Number(req.body.UserId) && req.body.Phone && Number(req.body.Phone)) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/UpdatePhoneNumber",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
...
export const DeleteContact = async (req, res) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/DeleteContact",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
...
export const AcceptRequestAddFriend = async (req, res) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/AcceptRequestAddFriend",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
...
export const DecilineRequestAddFriend = async (req, res) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/DecilineRequestAddFriend",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
...
export const DeleteRequestAddFriend = async (req, res) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/DeleteRequestAddFriend",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
...
export const UpdateUserName = async (req, res) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/UpdateUserName",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
...
export const UpdatePasswordUser = async (req, res) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/UpdatePasswordUser",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
...
export const ChangePassword = async (req, res) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/ChangePassword",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
...
export const GetInfoUser = async (req, res) => {
  try {
    ...
    let user_info = await User.findById(req.body.ID).lean();
    if (!user_info) {
...
export const GetContactCompany = async (req, res) => {
  try {
    ...
    let countLoad = req.body.countLoad || 500;
    let countContact = req.body.countContact;
    const condition = { id365: 1, userName: 1, email: 1, avatarUser: 1, status: 1, active: 1, isOnline: 1, looker: 1, statusEmotion: 1, lastActive: 1, linkAvatar: 1, companyId: 1, type365: 1 };
    let listIdFriendOut = [];
    let listFriendOut = await Contact.find(
    ...
    let user_list
    if (countLoad === 0) {
      user_list = await User.find({ _id: { $ne: userId }, companyId: idCom }, condition).skip(countContact).limit(500).lean()
    } else {
      user_list = await User.find({ _id: { $ne: userId }, companyId: idCom }, condition).skip(countContact).limit(countLoad).lean()
      if (user_list.length === 0) {
        user_list = await User.find({ _id: { $ne: userId }, companyId: idCom }, condition).skip(countContact).limit(500).lean();
      }
    }
...
export const GetListOfferContactByPhone = async (req, res) => {
  try {
    ...
    const condition = { email: 1, userName: 1, avatarUser: 1, email: 1, status: 1, isOnline: 1, linkAvatar: 1, companyId: 1, type365: 1 };
    let listIdFriend = [];
    let arr = [];
    let listFriend = await Contact.find(
      { $or: [{ userFist: userId }, { userSecond: userId }] }).limit(200).lean();
    ...
    let user_list = await User.find({
      _id: { $ne: userId }, companyId: { $ne: idCom },
      $or: [{ phone: fixPhone }, { email: fixPhone }]
    }, condition).lean()
    if (user_list.length > 0) {
      let t = getRandomInt(1, 4);
      for (let i = 0; i < user_list.length; i++) {
...
export const RegisterSuccess = async (req, res) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/RegisterSuccess",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
...
export const ChangeActive = async (req, res) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/ChangeActive",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
...
export const Logout = async (req, res) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/Logout",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
  ...
  try {
    ...
    if (req.body && req.body.ID) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/UpdateAcceptMessStranger",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
  ...
  try {
    ...
    if (req && req.body && Number(req.body.ID) && String(req.body.UserName)) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/ChangeUserName",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
  ...
  try {
    ...
    if (req && req.body && Number(req.body.userId) && Number(req.body.contactId)) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/RemoveSugges",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
...
export const NewAccountFromQLC = async (req, res) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/NewAccountFromQLC",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
...
export const AccountFrom_TimViec365 = async (req, res) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/AccountFrom_TimViec365",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
  ...
  try {
    if (req && req.body && req.body.ID365 && req.body.Type365 && req.body.Email) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/UpdateAllInfomation365",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
...
export const QR365 = async (req, res) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/QR365",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
  ...
  try {
    ...
    if (req.body.ID && req.body.fromWeb) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/Logout_all",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
...
export const OptimizeContact = async (req, res, next) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/OptimizeContact",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
...
export const OptimizeRequestContact = async (req, res, next) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/OptimizeRequestContact",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
...
export const OptimizeRequestContactStatus = async (req, res, next) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/OptimizeRequestContactStatus",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
  ...
  try {
    if (req.body) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/GetInfoUserFromHHP365",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
      ...
      let phone = req.body.phone;
      let id365 = req.body.id365;
      let idTimViec = req.body.idTimviec;
      let cc365 = 0;
      const data = {
        result: true
      }
      ...
      if (flagCheckRequest != 0) {
        ...
        dataUser = await User.find({ email: emailUser, type365: typeUser }).limit(1).lean();
        console.log("Duwx lieeuj user", dataUser)
        if (dataUser && dataUser.length > 0) {
          ...
          const user = await InsertNewUserService(nameUser, id365, idTimViec, typeUser, emailUser, passUser, 0, "", fromWeb)
  ...
  try {
    if (req.body.Email && req.body.Password && req.body.Type365) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/UpdatePassword",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
  ...
  try {
    if (req.body && req.body.number && String(req.body.number.includes("+84"))) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/TakeDataFireBaseOTP",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
  ...
  try {
    if (req.body && req.body.number && String(req.body.number.includes("+84"))) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/CountHistorySendSmsOtp",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
  ...
  try {
    ...
    if (req.body && req.body.userId && (!isNaN(req.body.userId))) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/ChangeAcceptDevice",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
...
export const DeleteHistoryOTPPhoneNumber = async (req, res) => {
  try {
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/DeleteHistoryOTPPhoneNumber",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
...
export const ToolUpdateAvatar = async (req, res) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/ToolUpdateAvatar",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
  ...
  try {
    if (req.body.number) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/UpdatePermissionChangePass",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
  ...
  try {
    if (req.body.number) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/TakePermissionChangePass",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
  ...
  try {
    ...
    if (req.body.numberEmail) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/VerifyAccount",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
  ...
  try {
    ...
    if (userId.length = type365.length) {
      for (let i = 0; i < userId.length; i++) {
        let user_info = await User.findOne({ id365: userId[i], type365: type365[i] });
        if (!user_info) {
          continue;
        }
  ...
  try {
    ...
    if (userId.length = type365.length) {
      for (let i = 0; i < userId.length; i++) {
        ...
        let condition = { id365: userId[i], type365: type365[i] };
        if (type365ele == 2) {
          condition = {
            $or: [
              {
  ...
  try {
    ...
    if (req.body && req.body.EmailPhone) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/VerifyUser",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
...
export const VerifyAll = async (req, res) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/VerifyAll",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
...
export const UpdateCompanyEmail = async (req, res) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/UpdateCompanyEmail",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
  ...
  try {
    if (req && req.body && req.body.userId && req.body.idTimViec) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/updateIdchatfromIdtimviec",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
  ...
  try {
    if (req.body && req.body.userId && req.body.contactId) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/updateBestFriend",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
...
export const ToolUpdateContact = async (req, res) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/ToolUpdateContact",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
...
export const CheckDoubleContact = async (req, res, next) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/CheckDoubleContact",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
  ...
  try {
    if (req.body && req.body.userId) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/deleteCompanyFriend",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
  ...
  try {
    if (req.body && req.body.userId) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/deleteRequestCompanyFriend",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
    ...
    if (req.body) {
      if (req.body.id365 && !req.body.Id) {
        ...
        if (req.body.dev === 'dev') {
          ...
          axios({
          method: "post",
          url: "http://210.245.108.202:9000/api/users/deleteUserChat",
          data: { ...req.body, dev: 'dev' },
          headers: { "Content-Type": "multipart/form-data" }
          }).catch(err => { console.log(err) })
          }
...
export const SetToOffline = async (req, res, next) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/SetToOffline",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
...
export const ToolMergerUser = async (req, res) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/ToolMergerUser",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
...
export const UpdateDoubleVerify = async (req, res, next) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/UpdateDoubleVerify",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
...
export const LogoutStrangeDevice = async (req, res, next) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/LogoutStrangeDevice",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
...
export const InsertFieldCollection = async (req, res, next) => {
  try {
    ...
    if (req.body.dev === 'dev') {
      ...
      axios({
      method: "post",
      url: "http://210.245.108.202:9000/api/users/InsertFieldCollection",
      data: { ...req.body, dev: 'dev' },
      headers: { "Content-Type": "multipart/form-data" }
      }).catch(err => { console.log(err) })
      }
  ...
  try {
    if (req.body.userId) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/UpdateSharePermission",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
  ...
  try {
    if (req.body.userId && req.body.pin) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/UpdatePinHiddenConversation",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
  ...
  try {
    if (req.body.userId) {
      ...
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/DeletePinHiddenConversation",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
  ...
  try {
    if (req.body.userId) {
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/ConfirmPinHiddenConv",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
...
export const ChangeName = async (req, res) => {
  try {
    ...
    let userCheck = await User.findOne({ _id: userId }).lean();
    if (userCheck) {
      userInfo = await User.findOneAndUpdate({ _id: userId}, { $set: { userName: req.body.userName } });

      if (req.file) {
        // Save the uploaded file data to the user's avatar field
        userInfo.avatarUser = req.file.originalname
        await userInfo.save();
      }
    }
    else {
  ...
  try {
    if (req.body.userId) {
      if (req.body.dev === 'dev') {
        ...
        axios({
        method: "post",
        url: "http://210.245.108.202:9000/api/users/ChangeNickNameUser",
        data: { ...req.body, dev: 'dev' },
        headers: { "Content-Type": "multipart/form-data" }
        }).catch(err => { console.log(err) })
        }
